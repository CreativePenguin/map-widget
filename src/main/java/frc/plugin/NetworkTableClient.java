...
public class NetworkTableClient {
    ...
    /* Not really meant for external use */
    ...
    public boolean getOrSetBoolean(String entryName) {
        if(!isEntryValid(entryName)) { 
            setBoolean(entryName, DEFAULT_BOOLEAN);
        }
        
        return getBoolean(entryName);
    }
    ...
    public double getOrSetDouble(String entryName) {
        if(!isEntryValid(entryName)) { 
            setDouble(entryName, DEFAULT_DOUBLE);
        }

        return getDouble(entryName);
    }
    ...
    public Number getOrSetNumber(String entryName) {
        if(!isEntryValid(entryName)) { 
            setNumber(entryName, DEFAULT_NUMBER);
        }

        return getNumber(entryName);
    }
    ...
    public String getOrSetString(String entryName) {
        if(!isEntryValid(entryName)) { 
            setString(entryName, DEFAULT_STRING);
        }
